(function () {
  ...
  angular.module('myApp').factory(serviceId, function newsService($http) {
    ...
    function getPostList() {
      ...
      return [
        {
          title: 'Post title 1'
          , date: new Date('12/12/15').toLocaleDateString("ru", options)
          ...
          title: 'Post title 2'
          , date: new Date('08/12/15').toLocaleDateString("ru", options)
          ...
          title: 'Post title 3'
          , date: new Date('10/12/16').toLocaleDateString("ru", options)
